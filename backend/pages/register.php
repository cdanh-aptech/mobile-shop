...
if(isset($_POST['btnDangKy'])) 
{
    ...
    mysqli_close($conn);
     ...
     try {
         ...
         <table>
             <tr>
                 <td><h1 style="color: red; font-size: 16px; text-align: center;">TRANG BÁN HÀNG MOBILE-SHOP</h1>
             ...
             <tr>
                 <td>
                     ...
                     <a href="$siteUrl/mobile-shop/backend/pages/kichhoattaikhoan.php?kh_tendangnhap=$kh_tendangnhap&kh_makichhoat=$kh_makichhoat">Kích hoạt tài khoản</a>
                 </td>
             </tr>
             <tr>
                 <td>
