...
if(isset($_POST['btnCapNhat'])) 
{
    ...
    // Câu lệnh UPDATE
    $sql = "UPDATE `nhasanxuat` SET nsx_ten='$tenLoai' WHERE nsx_ma=$nsx_ma;";
...
// Yêu cầu `Twig` vẽ giao diện được viết trong file `backend/nhasanxuat/edit.html.twig`
// với dữ liệu truyền vào file giao diện được đặt tên là `nhasanxuat`
